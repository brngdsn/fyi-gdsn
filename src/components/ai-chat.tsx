...
export function AIChat() {
  ...
  return (
    <div className={`flex flex-col ${hasStartedChat ? 'min-h-[calc(100vh-134px)]' : 'h-[calc(100vh-134px)]'}`}>
      {!hasStartedChat ? (
        <div className="flex-1 flex flex-col items-center justify-center space-y-8">
          ...
          <Card className="relative overflow-hidden rounded-xl border bg-white dark:border-gray-800 dark:bg-gradient-to-r dark:from-black dark:to-neutral-950 dark:shadow-2xl w-full max-w-2xl">
